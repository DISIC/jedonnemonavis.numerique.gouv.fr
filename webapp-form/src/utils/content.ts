...
export const CGU = {
    ...
    firstPart: {
        ...
        firstBlock: "Ce site permet de suivre l’avancée et la qualité de la dématérialisation des 250 démarches phares de l'État. Il met à disposition les données précises sur l’offre de services dématérialisés aux usagers et présente des indicateurs de qualité concrets mis à jour tous les 3 mois.",
        secondBlock: "Il permet également aux usagers de donner leurs avis sur les démarches en ligne qu’ils viennent d’effectuer, et en affiche les résultats de manière transparente. Un bouton/lien situé à la fin de la démarche permet d’accéder à ce service.",
        thirdBlock: {
            firstBlock: "Lorsque vous donnez un avis détaillé sur une démarche (espace d’expression libre), nous vous prions de :",
            secondBlock: ["ne pas nous communiquer d’informations personnelles, permettant de vous identifier ou d’identifier une autre personne (identité, date de naissance, adresse, courriel, y compris professionnel, identifiant administratif, etc.) ;", "ne pas inclure d’insultes ou de propos dénigrants ou diffamatoires à l’encontre d’une personne."],
        },
        fourthBlock: "Vous ne pouvez en tant qu’usager ou accompagnant évaluer qu’une seule fois la démarche. Vous pouvez néanmoins formuler un nouvel avis à chaque fois que vous effectuez à nouveau la même démarche.",
        fifthBlock: {
            firstBlock: "L'adresse URL qui permet d'accéder au service Vos démarches essentielles est la suivante :",
            url1: "https://observatoire.numerique.gouv.fr",
            secondBlock: "L'adresse URL vers laquelle sont dirigés les usagers qui donnent leurs avis à la fin d'une démarche est la suivante dépend de la démarche en question mais commence systématiquement par : ",
...
export const LegalNotice: LegalNotice = {
    ...
    sections: {
        "Éditeur": {
            content: ["Direction interministérielle du numérique (DINUM)", "20 Avenue de Ségur", "75007 PARIS"],
        },
        "Directrice de la publication": {
            content: ["Stéphanie Schaer, Directrice Interministérielle du Numérique (DINUM)."]
        },
