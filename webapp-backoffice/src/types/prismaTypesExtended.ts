...
const EntityWithUsersAndProducts = Prisma.validator<Prisma.EntityDefaultArgs>()(
	{
		include: {
			products: true,
			users: true
...
export type EntityWithUsersAndProducts = Prisma.EntityGetPayload<
	typeof EntityWithUsersAndProducts
>;
