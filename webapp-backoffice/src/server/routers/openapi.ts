...
export const openAPIRouter = router({
    ...
    publicData: publicProcedure
        .meta({ openapi: { 
			...
			enabled: true,
            tags: ['public'],
            summary: "Ce point d'accès retourne les données de satisfaction des utilisateurs pour toutes les démarches faisant actuellement partie du Top 250.",
    ...
    privateData: protectedApiProcedure
        .meta({ openapi: { 
			...
			enabled: true,
            tags: ['privé'],
            summary: "Ce point d'accès retourne les données de satisfaction des utilisateurs pour toutes les démarches liées au porteur du token fourni.",
            description: description,
            example: {
                request: {
                    "field_codes": ["satisfaction", "comprehension"],
