...
const EndpointsTab = ({ filterDoc, hasPath }: EndpointsTabProps) => {
	const fieldCodes = [
		...FIELD_CODE_SMILEY_VALUES,
		...FIELD_CODE_DETAILS_VALUES,
		...FIELD_CODE_BOOLEAN_VALUES
	...
	return (
		<div>
			...
			<p>
				...
				<strong>/services</strong>) et leurs statistiques de satisfaction
				agrégées (<strong>/statistiques</strong>)
				{hasPath('/avis') && (
					<>
			...
			{hasPath('/avis') && (
				<div className={fr.cx('fr-mt-8w')}>
					...
					<p>
						...
						synchronisation régulière, préférez le curseur aux dates : les
						bornes de <code>start_date</code> et <code>end_date</code> sont
						interprétées sur la journée entière, ce qui peut faire réapparaître
						un avis d'une fenêtre à la suivante.
					</p>
								...
								<tbody>
									...
									<tr>
										...
										<td>
											...
											<br />
											<span className={fr.cx('fr-hint-text')}>
												Omis: tous les avis | <code>true</code>: seulement ceux
												qui portent un verbatim | <code>false</code>: seulement
									...
									<tr>
										...
										<td>
											...
											<span className={fr.cx('fr-hint-text')}>
												...
												<code>metadata.next_cursor</code> de la réponse
												précédente
											</span>
										</td>
										<td>string</td>
									...
									<tr>
										...
										<td>
											...
											<br />
											<span className={fr.cx('fr-hint-text')}>
												Défaut: true | Passez <code>false</code> pour ne
												récupérer que les métadonnées des avis
											</span>
										</td>
										<td>boolean</td>
										<td>Non</td>
