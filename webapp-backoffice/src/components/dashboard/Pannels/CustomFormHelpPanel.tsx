...
const CustomFormHelpPanel = () => {
  ...
  return (
    <div className={cx(classes.mainContainer, fr.cx('fr-container', 'fr-p-6v', 'fr-mt-6v'))}>
      <div className={classes.container}>
        <Badge severity="new" className='fr-mb-2v' small>Beta</Badge>
        <span className={classes.smallTitle}>
          Personnalisez le formulaire du service 
        </span>
        <p className={fr.cx('fr-mb-0')}>Désormais, pour adapter vos formulaires à vos besoins spécifiques, vous pouvez  :</p>
        ...
        <p className={fr.cx('fr-mb-0', 'fr-mt-3v')}>Pour en savoir plus sur ces fonctionnalités et découvrir celles à venir, vous pouvez <Link href='/public/roadmap'>consulter notre feuille de route</Link>.</p>
      </div>
      <Image
