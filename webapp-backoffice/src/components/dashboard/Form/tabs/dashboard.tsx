...
const DashboardTab = ({hasNoReviews, isLoading}: Props) => {
  ...
  return (hasNoReviews ? (
    <div className={cx(classes.mainContainer, fr.cx('fr-container'))}>
      ...
      <div className={classes.container}>
        ...
        <p className={fr.cx('fr-mt-3v', 'fr-mb-0')}>Vous n’avez pas encore reçu d’avis de la part de vos utilisateurs.</p>
        <p className={fr.cx('fr-mb-3v')}>En attendant, vous pouvez découvrir nos conseils pour bien placer le bouton de récolte d’avis :</p>
        <Link
          href='#'
          target='_blank'
        >
