...
const ProductFormPage = (props: Props) => {
  ...
  return (
    <div className={fr.cx('fr-container', 'fr-my-4w')}>
      ...
      <Breadcrumb
        currentPageLabel={'Formulaire : ' + (form.title || form.form_template.title)}
      ...
      <div className={fr.cx('fr-grid-row', 'fr-grid-row--gutters', 'fr-my-6v')}>
        ...
        <div className={fr.cx('fr-col-12', 'fr-pb-0')}>
          <p className={fr.cx('fr-mb-0')}>
            ...
            </Link>. Les réponses que vous déposerez ne seront pas prises en compte dans les statistiques.
          </p>
        </div>
