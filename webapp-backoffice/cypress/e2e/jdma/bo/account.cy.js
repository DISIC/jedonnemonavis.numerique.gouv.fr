...
describe('Account page', () => {
    ...
    it('delete account', () => {
        ...
        cy.get(selectors.accountForm.confirm).should('be.visible').clear({force: true}).type('blabla');
        cy.contains('button', selectors.action.confirmDelete).should('be.disabled');
        cy.contains('p', 'Mot de confirmation incorrect').should('exist')
        cy.get(selectors.accountForm.confirm).should('be.visible').clear({force: true}).type('supprimer');
